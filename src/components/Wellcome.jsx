...
<div className={s.wrapper}>
              ...
              <div className={s.div2}>
                  Сайт разработан 10.01.29. Он поможет вам решить многие проблемы с вашим здоровьем. Здесь вы можете найти специалистов которые помогут вам, также на сайте имеются возможности, как
